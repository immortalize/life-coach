...
--}}
                            ...
                            <a href="{{ url('/register') }}">Add a reason </a>

                        @else
                            There is no reasons yet. <a href="{{ url('/register') }}">Add a reason! </a>
                        @endif
                    </div>
                </div>
                {{-- Reasons End  --}}
...
--}}
                            ...
                            <a href="{{ url('/register') }}">Add a effort </a>

                        @else
                            There is no efforts yet. <a href="{{ url('/register') }}">Add a effort! </a>
                        @endif
                    </div>
                </div>
                {{-- Efforts End  --}}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @if (count($steps) > 0)
                            ...
                            <a href="{{ url('/register') }}">Add another step</a>

                        @else
                            There is no steps yet. <a href="{{ url('/register') }}">Add a step! </a>
                        @endif
                    </div>
                </div>
                {{-- Steps End  --}}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @if (count($motivators) > 0)
                            ...
                            <a href="{{ url('/register') }}">Add a motivator </a>

                        @else
                            There is no motivators yet. <a href="{{ url('/register') }}">Add a motivator! </a>
                        @endif
                    </div>
                </div>
                {{-- motivators End  --}}
